...
/***********************************************************************
 * 
 * Klassen låter användaren mata in mätningar av temperatur under veckors
 * tid. Därefter beräknar klassen de minsta, högsta och medel-
 * temperaturerna för varje vecka samt hela mätperioden. Klassen visar
 * därefter resultatet.
 * 
...
public class Temperaturer {
	...
	//Leta efter den minsta och högsta temperaturen för varje vecka, samt beräkna medeltemperaturen.
	 	for(int vecka = 1; vecka <= antalVeckor; vecka++) {
			double sum = 0;
